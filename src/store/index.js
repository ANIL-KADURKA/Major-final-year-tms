...
export default new Vuex.Store({
  ...
  getters: {
    ...
    get_individual_ticket_data(state) {
      return state.individual_ticket_data
    }
  },
  mutations: {
    ...
    SET_TICKET_DATA(state, payload) {
      state.individual_ticket_data = payload;
    }
  },
  actions: {
    ...
    set_state_for_individual_ticket_page(context, payload) {
      context.commit('SET_TICKET_DATA', payload);
    },
